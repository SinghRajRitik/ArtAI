...
const Header = () => {
  ...
  return (<>
    ...
    >
      ...
      >
        <p>
          Transform Words into  Best Arts
        </p>
        <img src={assets.star_icon} alt='' />
      </motion.div>
      <motion.h1 className='text-4xl max-w-[300px] sm:text-6xl sm:max-w-[590] mx-auto mt-10 text-center'
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.4, duration: 2 }}
      >Transform Words into <span className='text-red-600 font-bold'>Art</span> in seconds. </motion.h1>
      <motion.p className='text-center max-w-xl ma-auto mt-5'
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <img src={assets.star_group} alt='' className='h-6' /> Generate Image
      </motion.button>
    </motion.div >
